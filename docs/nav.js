(function(){
  var NAV = [["Overview", [["Index", "index", true], ["Knowledge graph (OKF)", "graph", false]]], ["Product", [["PRD (CTAM Pathfinder)", "prd", false], ["PRD validation report \u2014 2026-06-17 (5/5)", "prd-validation-report-2026-06-17", false], ["PRD validation report \u2014 2026-06-10", "prd-validation-report-2026-06-10", false]]], ["As-is \u2014 JI Architecture Views", [["System Context (as-is)", "asis/system-context", false], ["Components (as-is)", "asis/components", false]]], ["As-is \u2014 JI Analysis Pack", [["Functional modules (as-is)", "architecture/asis/functional-modules", false], ["Data dependencies (as-is)", "architecture/asis/data-dependencies", false], ["Integration dependencies (as-is)", "architecture/asis/integration-dependencies", false]]], ["As-is \u2014 Payments", [["Payment templates (as-is)", "architecture/asis/payments/payment-templates", false]]], ["As-is \u2014 JI Database Schema", [["Database index", "asis/database/index", false], ["Schema overview", "asis/database/ji_schema_overview", false], ["Judges Profile & Reference", "asis/database/ji_schema_judges-profile", false], ["Working Patterns, Tickets & Stats", "asis/database/ji_schema_judges-patterns", false], ["Absence & Cover Workflow", "asis/database/ji_schema_absence-cover", false], ["Bookings & Sittings", "asis/database/ji_schema_bookings-sittings", false], ["Reference Data", "asis/database/ji_schema_reference-work", false], ["Audit & Cross-cutting", "asis/database/ji_schema_audit-cross-cutting", false], ["Companion reference (triggers, FKs, externals)", "asis/database/ji_schema_companion", false]]], ["To-be \u2014 CTAM Pathfinder Architecture", [["Architecture (index)", "architecture", false], ["Architecture summary", "architecture-summary", false]]], ["To-be \u2014 CTAM Pathfinder Analysis", [["Function decomposition (as-is capabilities)", "architecture/tobe/analysis/function-decomposition", false]]], ["To-be \u2014 CTAM Pathfinder Reference", [["User types", "architecture/tobe/user-types", false], ["Authoritative table ownership", "architecture/tobe/data-tables", false], ["Conventions", "architecture/tobe/conventions", false], ["Repository strategy", "architecture/tobe/repository-strategy", false], ["Repository structure", "architecture/tobe/repo-structure", false], ["Starter template", "architecture/tobe/starter-template", false], ["Functional requirements coverage", "architecture/tobe/functional-requirements-coverage", false], ["Non-functional requirements coverage", "architecture/tobe/non-functional-requirements-coverage", false]]], ["To-be \u2014 CTAM Pathfinder Sequence Diagrams", [["Authentication & authorisation", "architecture/tobe/sequence-diagrams/user-authentication-and-authorisation", false], ["JOH onboarding & sitting gen.", "architecture/tobe/sequence-diagrams/joh-onboarding-and-sitting-generation", false], ["Absence \u2192 Reconciliation", "architecture/tobe/sequence-diagrams/absence-to-reconciliation", false], ["Salaried sitting confirmation", "architecture/tobe/sequence-diagrams/salaried-sitting-confirmation", false], ["Payment batch flow", "architecture/tobe/sequence-diagrams/payment-batch-flow", false], ["Itinerary federated read", "architecture/tobe/sequence-diagrams/itinerary-federated-read", false], ["MI Feed & Reports", "architecture/tobe/sequence-diagrams/mi-feed-and-reports-consumption", false], ["Admin maintenance flows", "architecture/tobe/sequence-diagrams/admin-maintenance-flows", false]]], ["To-be \u2014 CTAM Pathfinder Open Items", [["Gaps", "architecture/tobe/gaps", false], ["Assumptions", "architecture/tobe/assumptions", false], ["Changelog", "architecture/tobe/changelog", false]]], ["Change Control & Readiness", [["Sprint Change Proposal Log (all 29 proposals, 2026-05-15 \u2192 2026-08-25, consolidated)", "sprint-change-proposal-log", false], ["Readiness \u2014 2026-05-15 rev2 (superseded by SCP 2026-06-10; SSCS-cohort assessment pending)", "implementation-readiness-report-2026-05-15-rev2", false], ["Readiness \u2014 2026-05-15 rev1 (superseded by rev2)", "implementation-readiness-report-2026-05-15", false], ["Readiness \u2014 2026-05-06 (historical)", "implementation-readiness-report-2026-05-06", false], ["Readiness \u2014 2026-05-05 (historical)", "implementation-readiness-report-2026-05-05", false]]], ["Implementation \u2014 Epics (Foundations)", [["Delivery operating model (control plane \u00b7 context bus \u00b7 execution units)", "architecture/tobe/delivery-operating-model", false], ["Delivery control plane (dispatch \u2192 execute \u2192 signal)", "delivery/README", false], ["Epics index", "epics/index", false], ["Requirements inventory", "epics/requirements-inventory", false], ["Phase \u00d7 Area framework", "epics/framework", false], ["FR coverage map", "epics/fr-coverage-map", false]]], ["Implementation \u2014 Phase 0 (narrowed to epics 0.0-0.4, SCP 2026-08-25d)", [["Phase 0 overview", "epics/phase-0/index", false], ["Epic 0.0 \u2014 Platform estate provisioned, verifiable, CNP-compliant (7 stories)", "epics/phase-0/epic-0.0-platform-estate-provisioned", false], ["Epic 0.1 \u2014 JOH domain schema is designed and implemented in PostgreSQL (2 stories)", "epics/phase-0/epic-0.1-postgres-sql-schema-design", false], ["Epic 0.2 \u2014 JOH eLinks mock API stands in for the unconfirmed contract (3 stories)", "epics/phase-0/epic-0.2-joh-elinks-mock-api-stands-in", false], ["Epic 0.3 \u2014 JOH reference-data ETL process (3 stories)", "epics/phase-0/epic-0.3-joh-reference-data-etl-process", false], ["Epic 0.4 \u2014 JOH data read-only API (2 stories)", "epics/phase-0/epic-0.4-joh-data-read-only-api", false]]]];
