...
- [CTAM Pathfinder BMAD state](project_bmad_ctam_pathfinder_state.md) — architecture v3.0 + epics restructured for SCP 2026-06-10; next: readiness check → sprint planning
