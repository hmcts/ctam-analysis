...
description: 'Date: 2026-07-06 — Move the shared Azure estate out of ctam-reference-data into a dedicated ctam-shared-infrastructure repo per the HMCTS Cloud Native Platform standard, provisioned and independently verified in a new Epic 0.0.'
resource: 'sprint-change-proposal-2026-07-06.html'
tags: [ctam-pathfinder, change-control, infrastructure, cnp]
