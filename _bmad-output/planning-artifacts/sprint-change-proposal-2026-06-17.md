...
trigger: 'Re-scope the programme''s first deliverable around the inbound JOH eLinks + MRD integrations and their associated APIs; resolve where the orchestration components live and whether a new ctam-integrations repo is needed.'
mode: batch
scope: moderate
