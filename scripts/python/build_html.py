...
# never remove it.
# `.nojekyll` disables Jekyll so this pandoc-generated static site deploys
# byte-for-byte on GitHub Pages; it must survive the clean step (it is not
# regenerated by this script).
KEEP = {"claude-skills.md", "architecture/asis", ".nojekyll"}
...
ASIS_MARKDOWN: List[Tuple[str, str]] = [
    ...
    ("payments/payment-templates.md", "architecture/asis/payments/payment-templates"),
]
...
NAV: List[Tuple[str, List[Tuple[str, str, bool]]]] = [
    ...
    ("As-is — Payments", [
        ("Payment templates (as-is)", "architecture/asis/payments/payment-templates", False),
    ]),
    ...
    ("Change Control & Readiness", [
        ("Sprint Change Proposal — 2026-08-21f (restore epic-level tracking for Phase 1)", "sprint-change-proposal-2026-08-21f", False),
        ("Sprint Change Proposal — 2026-08-21e (strip stories from all Phase 1 epics)", "sprint-change-proposal-2026-08-21e", False),
        ("Sprint Change Proposal — 2026-08-21d (annotate sprint-status.yaml epics with their titles)", "sprint-change-proposal-2026-08-21d", False),
        ...
        ("Sprint Change Proposal — 2026-08-20g (move Epic 0.10 to a new Phase 1 as Epic 1.0)", "sprint-change-proposal-2026-08-20g", False),
        ("Sprint Change Proposal — 2026-08-20f (new Epic 0.10: JOH eLinks API contract confirmed + CI mock)", "sprint-change-proposal-2026-08-20f", False),
        ("Sprint Change Proposal — 2026-08-20e (move MRD reference-data read-API epic from 0.9 to 0.6)", "sprint-change-proposal-2026-08-20e", False),
        ("Sprint Change Proposal — 2026-08-20d (split Epic 0.5 into JOH and MRD reference-data read-API epics)", "sprint-change-proposal-2026-08-20d", False),
        ("Sprint Change Proposal — 2026-08-20c (renumber JOH/MRD ETL epics 0.7/0.8 to 0.2/0.3)", "sprint-change-proposal-2026-08-20c", False),
        ("Sprint Change Proposal — 2026-08-20b (split Epic 0.1 into schema-design + two ETL-process epics)", "sprint-change-proposal-2026-08-20b", False),
    ...
    ("Implementation — Phase 1 (Foundations; platform-then-integrations-first)", [
        ...
        ("Epic 1.1 — Postgres reference-data schema designed and scaffolded", "epics/phase-1/epic-1.1-postgres-db-schema-design", False),
        ("Epic 1.2 — JOH reference data ETL process", "epics/phase-1/epic-1.2-joh-reference-data-etl-process", False),
        ("Epic 1.3 — MRD reference data ETL process", "epics/phase-1/epic-1.3-mrd-reference-data-etl-process", False),
        ("Epic 1.4 — User authenticates", "epics/phase-1/epic-1.4-user-authenticates", False),
        ("Epic 1.5 — JOH + CTAM-owned reference data read-only API", "epics/phase-1/epic-1.5-joh-reference-data-read-api", False),
        ("Epic 1.6 — MRD reference data read-only API", "epics/phase-1/epic-1.6-mrd-reference-data-read-api", False),
        ("Epic 1.7 — User populations bootstrapped", "epics/phase-1/epic-1.7-user-populations-bootstrapped", False),
        ("Epic 1.8 — Notification scaffolded", "epics/phase-1/epic-1.8-system-dispatches-emails", False),
        ("Epic 1.9 — Context bus published + shared config baseline (1 story)", "epics/phase-1/epic-1.9-context-bus-and-shared-baseline", False),
    ]),
...
.living-doc-notice{background:#fff8c5;border:1px solid #d4a72c;border-left:4px solid #d4a72c;border-radius:6px;padding:12px 16px;margin:0 0 22px;font-size:14px;color:#4d3800;line-height:1.55}
.living-doc-notice strong{color:#3d2e00}
