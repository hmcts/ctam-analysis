...
NAV: List[Tuple[str, List[Tuple[str, str, bool]]]] = [
    ...
    ("Change Control & Readiness", [
        ("Sprint Change Proposal — 2026-08-18e (Phase 0 repo-impact review; Epics 0.A/0.B; DB roles assigned)", "sprint-change-proposal-2026-08-18e", False),
        ...
        ("Sprint Change Proposal — 2026-08-18d (eLinks v5 mock adopted; 4 assumptions falsified)", "sprint-change-proposal-2026-08-18d", False),
        ("Sprint Change Proposal — 2026-08-18c (Phase 0-Mock tier; 0.9/0.10 → 0M.1/0M.2)", "sprint-change-proposal-2026-08-18c", False),
        ("Sprint Change Proposal — 2026-08-18b (upstream source mocks; superseded on numbering by 18c)", "sprint-change-proposal-2026-08-18b", False),
    ...
    ("Implementation — Phase 0-Mock (upstream source stand-ins; pre-Phase-0 tier)", [
        ("Phase 0-Mock overview", "epics/phase-0-mock/index", False),
        ("Epic 0M.1 — JOH eLinks mock source (2 stories; feeds Epic 0.2)", "epics/phase-0-mock/epic-0M.1-joh-reference-data-mocked", False),
        ("Epic 0M.2 — MRD feed mock source (2 stories; feeds Epic 0.3)", "epics/phase-0-mock/epic-0M.2-mrd-reference-data-mocked", False),
    ]),
    ("Implementation — Phase 0 (enablement-then-platform-then-design-then-mock-then-integrations-first; 0.A/0.B added 2026-08-18e)", [
        ("Phase 0 overview", "epics/phase-0/index", False),
        ("Epic 0.A — Context bus, scaffolding toolchain, platform runbooks (3 stories; precedes 0.0)", "epics/phase-0/epic-0.A-architecture-context-bus-and-scaffolding", False),
        ...
        ("Epic 0.B — Shared DB baseline + per-service DB roles (1 story; follows 0.0)", "epics/phase-0/epic-0.B-shared-db-baseline-and-service-roles", False),
